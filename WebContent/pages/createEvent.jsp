						...
						<form id="contact-form" action="../front?key=createEvent"
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label> 행사 이미지 </label> 
										<input type="file" name="evImage" id="file" accept="image/gif, image/jpeg, image/png">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label> 행사 상세 이미지 </label> 
										<input type="file" name="evImageDetail" id="file" accept="image/gif, image/jpeg, image/png">
									</div>
								</div>
							</div>
