	...
	<div class="container">
		...
		<div class="row text-center">
			...
			<div id="chDesc" class="team team-list wow slideInRight">
				<h4>개설행사: n개</h4>
				<a href=""><p id="p"><img src="images/channel.svg">&nbsp;&nbsp;채널설정</p></a>
				<p id="p">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
				<a href=""><p id="p"><img src="images/authority.svg">&nbsp;&nbsp;권한설정</p></a>
				<p id="p">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
				<a href=""><p id="p"><img src="images/delete.svg">&nbsp;&nbsp;채널삭제</p></a><br>
